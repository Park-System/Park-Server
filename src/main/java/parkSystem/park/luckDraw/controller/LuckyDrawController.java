...
public class LuckyDrawController {
    ...
    @PostMapping("/raffle")
    public ResponseEntity<List<LuckDrawRaffleResDTO>> raffleLuckyDraw(@RequestParam Long luckDrawId){
        List<LuckDrawRaffleResDTO> winners = luckyDrawService.raffleLuckyDraw(luckDrawId);
